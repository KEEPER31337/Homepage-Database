...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`ctf_team` (`id`, `name`, `description`, `register_time`, `creator`, `score`, `contest_id`, `last_solve_time`) VALUES (1, 'virtual_ctf_team', 'virtual_ctf_team_description', '2022-01-01 00:00:00', 1, 0, 1, DEFAULT);
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`ctf_challenge` (`id`, `name`, `description`, `register_time`, `creator`, `is_solvable`, `type_id`, `category_id`, `score`, `contest_id`, `file_id`, `max_submit_count`) VALUES (1, 'virtual_ctf_challenge', 'virtual_ctf_challenge_description', '2022-01-01 00:00:00', 1, 0, NULL, NULL, 0, 1, NULL, DEFAULT);
