...
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (5, 'ROLE_FRONT_전산관리자', 15);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (6, 'ROLE_BACK_전산관리자', 15);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (7, 'ROLE_서기', 16);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (8, 'ROLE_총무', 17);
