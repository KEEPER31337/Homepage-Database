...
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (3, 'profile_badge_grade_first.png', 'keeper_files/thumbnail/badge/profile_badge_grade_first.png', 33609, DEFAULT, '1.1.1.1', NULL);
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (4, 'profile_badge_grade_second.png', 'keeper_files/thumbnail/badge/profile_badge_grade_second.png', 33609, DEFAULT, '1.1.1.1', NULL);
