...
-- -----------------------------------------------------
-- Table `keeper`.`book_borrow_status`
-- -----------------------------------------------------
...
USE `keeper`$$
DROP TRIGGER IF EXISTS `keeper`.`book_borrow_log_BEFORE_UPDATE` $$
USE `keeper`$$
CREATE DEFINER = CURRENT_USER TRIGGER `keeper`.`book_borrow_log_BEFORE_UPDATE` BEFORE UPDATE ON `book_borrow_log` FOR EACH ROW
BEGIN
	SET NEW.update_time = CURRENT_TIME;
END$$
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (1, 'default_thumbnail_member.png', 'keeper_files/thumbnail/default/default_thumbnail_member.png', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (2, 'default_thumbnail_posting.png', 'keeper_files/thumbnail/default/default_thumbnail_posting.png', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (3, 'profile_badge_grade_first.gif', 'keeper_files/thumbnail/badge/profile_badge_grade_first.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (4, 'profile_badge_grade_second.gif', 'keeper_files/thumbnail/badge/profile_badge_grade_second.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (5, 'profile_badge_state_graduate.gif', 'keeper_files/thumbnail/badge/profile_badge_state_graduate.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (6, 'profile_badge_state_quit.png', 'keeper_files/thumbnail/badge/profile_badge_state_quit.png', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (7, 'profile_badge_state_sleep.gif', 'keeper_files/thumbnail/badge/profile_badge_state_sleep.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (8, 'profile_badge_state_regular.gif', 'keeper_files/thumbnail/badge/profile_badge_state_regular.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (9, 'default_thumbnail_intro.png', 'keeper_files/thumbnail/default/default_thumbnail_intro.png', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (10, 'default_thumbnail_book.png', 'keeper_files/thumbnail/default/default_thumbnail_book.png', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (11, 'profile_badge_role_chairman.gif', 'keeper_files/thumbnail/badge/profile_role_chairman.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (12, 'profile_badge_role_vice_chairman.gif', 'keeper_files/thumbnail/badge/profile_role_vice_chairman.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (13, 'profile_badge_role_external_manager.gif', 'keeper_files/thumbnail/badge/profile_badge_role_external_manager.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (14, 'profile_badge_role_study_manager.gif', 'keeper_files/thumbnail/badge/profile_badge_role_study_manager.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (15, 'profile_badge_role_it_manager.gif', 'keeper_files/thumbnail/badge/profile_badge_role_it_manager.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (16, 'profile_badge_role_clerk.gif', 'keeper_files/thumbnail/badge/profile_badge_role_clerk.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (17, 'profile_badge_role_general_affairs.gif', 'keeper_files/thumbnail/badge/profile_badge_role_general_affairs.gif', 33609, DEFAULT, '1.1.1.1');
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`) VALUES (18, 'profile_badge_role_librarian.gif', 'keeper_files/thumbnail/badge/profile_badge_role_librarian.gif', 33609, DEFAULT, '1.1.1.1');
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`member` (`id`, `login_id`, `email_address`, `password`, `real_name`, `birthday`, `student_id`, `register_time`, `update_time`, `member_type_id`, `member_rank_id`, `point`, `level`, `thumbnail_id`, `generation`, `total_attendance`) VALUES (1, 'virtual_member', 'virtual_email', 'virtual_password', '탈퇴회원', NULL, '000000000', '2022-01-01 00:00:00', DEFAULT, NULL, NULL, 0, 0, 6, NULL, DEFAULT);

COMMIT;


-- -----------------------------------------------------
-- Data for table `keeper`.`book_borrow_status`
-- -----------------------------------------------------
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`book_borrow_status` (`id`, `status`) VALUES (DEFAULT, '대출 대기');
INSERT INTO `keeper`.`book_borrow_status` (`id`, `status`) VALUES (DEFAULT, '대출 반려');
INSERT INTO `keeper`.`book_borrow_status` (`id`, `status`) VALUES (DEFAULT, '대출 중');
INSERT INTO `keeper`.`book_borrow_status` (`id`, `status`) VALUES (DEFAULT, '반납 대기');
INSERT INTO `keeper`.`book_borrow_status` (`id`, `status`) VALUES (DEFAULT, '반납 완료');
...
INSERT INTO `keeper`.`category` (`id`, `name`) VALUES (201, '스터디');
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`posting` (`id`, `title`, `content`, `member_id`, `visit_count`, `register_time`, `update_time`, `ip_address`, `allow_comment`, `is_notice`, `is_secret`, `is_temp`, `password`, `category_id`, `thumbnail_id`) VALUES (1, 'virtual_posting', 'virtual_posting_content', 1, DEFAULT, '1970-01-01 00:00:00', '1970-01-01 00:00:00', '0.0.0.0', DEFAULT, DEFAULT, DEFAULT, DEFAULT, NULL, 1, NULL);
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (1, 'ROLE_회장');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (2, 'ROLE_부회장');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (3, 'ROLE_대외부장');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (4, 'ROLE_학술부장');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (5, 'ROLE_FRONT_전산관리자');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (6, 'ROLE_서기');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (7, 'ROLE_총무');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (8, 'ROLE_사서');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (9, 'ROLE_회원');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (10, 'ROLE_출제자');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (11, 'ROLE_BACK_전산관리자');
INSERT INTO `keeper`.`member_job` (`id`, `name`) VALUES (12, 'ROLE_INFRA_전산관리자');
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`ctf_challenge` (`id`, `name`, `description`, `register_time`, `update_time`, `creator`, `is_solvable`, `type_id`, `score`, `contest_id`, `max_submit_count`) VALUES (1, 'virtual_ctf_challenge', 'virtual_ctf_challenge_description', '2022-01-01 00:00:00', DEFAULT, 1, 0, NULL, 0, 1, DEFAULT);
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`seminar` (`id`, `open_time`, `attendance_start_time`, `attendance_close_time`, `lateness_close_time`, `attendance_code`, `name`, `register_time`, `update_time`, `starter_id`) VALUES (DEFAULT, '2022-01-01 00:00:00', '2022-01-01 00:00:00', '2022-01-01 00:00:00', '2022-01-01 00:00:00', '000', 'virtual_seminar', DEFAULT, DEFAULT, NULL);
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`merit_type` (`id`, `merit`, `detail`, `is_merit`) VALUES (DEFAULT, 0, 'virtual_merit', 0);
INSERT INTO `keeper`.`merit_type` (`id`, `merit`, `detail`, `is_merit`) VALUES (DEFAULT, 3, '결석', 0);
INSERT INTO `keeper`.`merit_type` (`id`, `merit`, `detail`, `is_merit`) VALUES (DEFAULT, 3, '지각 2회', 0);
