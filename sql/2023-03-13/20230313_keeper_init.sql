...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`posting` (`id`, `title`, `content`, `member_id`, `visit_count`, `comment_count`, `register_time`, `update_time`, `ip_address`, `allow_comment`, `is_notice`, `is_secret`, `is_temp`, `password`, `category_id`, `thumbnail_id`) VALUES (1, 'virtual_posting', 'virtual_posting_content', 1, DEFAULT, DEFAULT, '1970-01-01 00:00:00', '1970-01-01 00:00:00', '0.0.0.0', DEFAULT, DEFAULT, DEFAULT, DEFAULT, NULL, 1, NULL);
