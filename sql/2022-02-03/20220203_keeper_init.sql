...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`member` (`id`, `login_id`, `email_address`, `password`, `real_name`, `nick_name`, `birthday`, `student_id`, `register_date`, `member_type_id`, `member_rank_id`, `point`, `level`, `thumbnail_id`, `merit`, `demerit`) VALUES (0, 'virtual_member', 'virtual_email', 'virtual_password', '탈퇴회원', '탈퇴회원', NULL, '000000000', '2022-01-01 00:00:00', NULL, NULL, 0, 0, NULL, 0, 0);
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`category` (`id`, `name`, `parent_id`) VALUES (0, 'root_category', NULL);
