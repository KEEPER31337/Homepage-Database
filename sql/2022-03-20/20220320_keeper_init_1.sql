...
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (5, 'profile_badge_state_graduate.png', 'keeper_files/thumbnail/badge/profile_badge_state_graduate.png', 33609, DEFAULT, '1.1.1.1', NULL);
...
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (7, 'profile_badge_state_sleep.png', 'keeper_files/thumbnail/badge/profile_badge_state_sleep.png', 33609, DEFAULT, '1.1.1.1', NULL);
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (8, 'profile_badge_state_regular.png', 'keeper_files/thumbnail/badge/profile_badge_state_regular.png', 33609, DEFAULT, '1.1.1.1', NULL);
...
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (3, 'keeper_files/thumbnail/badge/profile_badge_grade_first.png', 3);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (4, 'keeper_files/thumbnail/badge/profile_badge_grade_second.png', 4);
...
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (11, 'dummy', 1);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (12, 'dummy', 1);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (13, 'dummy', 1);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (14, 'dummy', 1);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (15, 'dummy', 1);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (16, 'dummy', 1);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (17, 'dummy', 1);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (18, 'dummy', 1);
...
INSERT INTO `keeper`.`category` (`id`, `name`, `parent_id`, `href`) VALUES (106402, '	기자재 신청', 	5, '	library');
