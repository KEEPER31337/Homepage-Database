...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`ctf_submit_log` (`id`, `submit_time`, `flag_submitted`, `is_correct`, `team_name`, `submitter_login_id`, `submitter_realname`, `challenge_name`, `contest_name`) VALUES (1, '2022-01-01 00:00:00', 'virtual_ctf_submit_log_flag_submitted', 0, 'virtual_ctf_submit_log_team_name', 'virtual_ctf_submit_log_submitter_login_id', 'virtual_ctf_submit_log_submitter_realname', 'virtual_ctf_submit_log_challenge_name', 'virtual_ctf_submit_log_contest_name');
