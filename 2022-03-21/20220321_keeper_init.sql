...
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (11, 'profile_role_chairman.gif', 'keeper_files/thumbnail/badge/profile_role_chairman.gif', 33609, DEFAULT, '1.1.1.1', NULL);
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (12, 'profile_role_vice_chairman.gif', 'keeper_files/thumbnail/badge/profile_role_vice_chairman.gif', 33609, DEFAULT, '1.1.1.1', NULL);
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (13, 'profile_role_external_manager.gif', 'keeper_files/thumbnail/badge/profile_role_external_manager.gif', 33609, DEFAULT, '1.1.1.1', NULL);
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (14, 'profile_role_study_manager.gif', 'keeper_files/thumbnail/badge/profile_role_study_manager.gif', 33609, DEFAULT, '1.1.1.1', NULL);
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (15, 'profile_role_it_manager.gif', 'keeper_files/thumbnail/badge/profile_role_it_manager.gif', 33609, DEFAULT, '1.1.1.1', NULL);
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (16, 'profile_role_clerk.gif', 'keeper_files/thumbnail/badge/profile_role_clerk.gif', 33609, DEFAULT, '1.1.1.1', NULL);
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (17, 'profile_role_general_affairs.gif', 'keeper_files/thumbnail/badge/profile_role_general_affairs.gif', 33609, DEFAULT, '1.1.1.1', NULL);
INSERT INTO `keeper`.`file` (`id`, `file_name`, `file_path`, `file_size`, `upload_time`, `ip_address`, `posting_id`) VALUES (18, 'profile_role_librarian.gif', 'keeper_files/thumbnail/badge/profile_role_librarian.gif', 33609, DEFAULT, '1.1.1.1', NULL);
...
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (11, 'keeper_files/thumbnail/badge/profile_role_chairman.gif', 11);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (12, 'keeper_files/thumbnail/badge/profile_role_vice_chairman.gif', 12);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (13, 'keeper_files/thumbnail/badge/profile_role_external_manager.gif', 13);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (14, 'keeper_files/thumbnail/badge/profile_role_study_manager.gif', 14);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (15, 'keeper_files/thumbnail/badge/profile_role_it_manager.gif', 15);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (16, 'keeper_files/thumbnail/badge/profile_role_clerk.gif', 16);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (17, 'keeper_files/thumbnail/badge/profile_role_general_affairs.gif', 17);
INSERT INTO `keeper`.`thumbnail` (`id`, `path`, `file_id`) VALUES (18, 'keeper_files/thumbnail/badge/profile_role_librarian.gif', 18);
...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_회장', NULL);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_부회장', NULL);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_대외부장', NULL);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_학술부장', NULL);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_전산관리자', NULL);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_서기', NULL);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_총무', NULL);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_사서', NULL);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_회원', NULL);
