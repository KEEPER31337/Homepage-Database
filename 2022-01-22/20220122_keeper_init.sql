...
-- -----------------------------------------------------
-- Table `keeper`.`original_image`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `keeper`.`original_image` ;

CREATE TABLE IF NOT EXISTS `keeper`.`original_image` (
...
CREATE TABLE IF NOT EXISTS `keeper`.`thumbnail` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_thumbnail_original_image1_idx` (`original_image_id` ASC) VISIBLE,
  CONSTRAINT `fk_thumbnail_original_image1`
    FOREIGN KEY (`original_image_id`)
    REFERENCES `keeper`.`original_image` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `keeper`.`static_write_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `keeper`.`static_write_type` ;

CREATE TABLE IF NOT EXISTS `keeper`.`static_write_type` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `keeper`.`static_write_title` (
  ...
  `type` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_static_write_static_write_type1_idx` (`type` ASC) VISIBLE,
  CONSTRAINT `fk_static_write_static_write_type1`
    FOREIGN KEY (`type`)
    REFERENCES `keeper`.`static_write_type` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Data for table `keeper`.`static_write_type`
-- -----------------------------------------------------
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`static_write_type` (`id`, `name`) VALUES (DEFAULT, 'intro');
INSERT INTO `keeper`.`static_write_type` (`id`, `name`) VALUES (DEFAULT, 'activity');
INSERT INTO `keeper`.`static_write_type` (`id`, `name`) VALUES (DEFAULT, 'excellence');
INSERT INTO `keeper`.`static_write_type` (`id`, `name`) VALUES (DEFAULT, 'history');
