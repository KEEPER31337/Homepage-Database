...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_회장', 11);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_부회장', 12);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_대외부장', 13);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_학술부장', 14);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_전산관리자', 15);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_서기', 16);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_총무', 17);
INSERT INTO `keeper`.`member_job` (`id`, `name`, `badge_thumbnail_id`) VALUES (DEFAULT, 'ROLE_사서', 18);
