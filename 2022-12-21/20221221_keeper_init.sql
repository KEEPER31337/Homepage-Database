...
START TRANSACTION;
USE `keeper`;
INSERT INTO `keeper`.`ctf_challenge` (`id`, `name`, `description`, `register_time`, `creator`, `is_solvable`, `type_id`, `score`, `contest_id`, `file_id`, `max_submit_count`) VALUES (1, 'virtual_ctf_challenge', 'virtual_ctf_challenge_description', '2022-01-01 00:00:00', 1, 0, NULL, 0, 1, NULL, DEFAULT);
